...
export const SportingEventSchema = z.object({
  ...
  rules: z.string().max(16384).nullable().optional(),
  disclaimer_of_liability: z.string().max(8192).nullable().optional(),
  ...
  external_register_url: z.string().max(512).nullable().optional(),
