  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center">
        <div
            className={`transition-all duration-300 ease-out ${isJumping ? '-translate-y-40 rotate-12 scale-110' : ''}`}
            style={{
              animation: 'run 0.7s infinite ease-in-out alternate'
            }}
        >
          <img src={Stickman} alt="Stickman" className="w-32 h-32 text-gray-800" />
        </div>
